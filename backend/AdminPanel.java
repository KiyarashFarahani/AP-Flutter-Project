...
public class AdminPanel extends JFrame {
    ...
    private JPanel createUsersPanel() {
        ...
        usersTable.getColumnModel().getColumn(5).setCellEditor(new ButtonEditor(new JCheckBox(), this));
        ...
        public Object getCellEditorValue() {
            ...
            if (isPushed) {
                if ("View Details".equals(label)) {
                    ...
                    SwingUtilities.invokeLater(() -> {
                        Song song = adminPanelInstance.allSongs.get(currentRow);
                    ...
                    SwingUtilities.invokeLater(() -> {
                        User user = adminPanelInstance.allUsers.get(currentRow);
